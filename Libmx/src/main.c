...
int main(void) {
    ...
    //     mx_printstr("4 bytes:\n"); mx_print_unicode(128527); mx_printstr("\n");
    ...
    //     mx_printstr("mx_print_strarr return \"abc xyz ghi def\"? | "); mx_print_strarr(print_strarr, " blya ");
...
//         t_list *create_node = mx_create_node(create_node_str);
//         t_list *head = create_node;
...
//             mx_printstr("\""); mx_printstr(buf); mx_printstr("\""); mx_printstr(" ");
//             // mx_printstr("\""); mx_printstr(back_new_list->data); mx_printstr("\""); mx_printstr(" ");
//             back_new_list = back_new_list->next;
//         }
//         mx_printstr("\n");
//         while (back_new_list)
//             mx_pop_back(&back_new_list);
//         while (back_head)
